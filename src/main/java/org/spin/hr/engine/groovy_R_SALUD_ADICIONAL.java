 ...
 */
public class groovy_R_SALUD_ADICIONAL implements RuleInterface {
	...
	public Object run(MHRProcess process, Map<String, Object> engineContext) {
		...
		double result = 0;
		description = null;
		String afpvalue =process.getAttributeString("P_SALUD_ADICIONAL");
		if(afpvalue == null)
			return result;
		double rate = 0.07;
		double imponible = process.getConcept("R_Imponibles");
		result = rate*imponible;
		return result;
	}
